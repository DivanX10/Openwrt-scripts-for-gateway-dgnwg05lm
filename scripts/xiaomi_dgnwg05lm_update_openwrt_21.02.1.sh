...
#Script for updating OpenWRT from version 19.07 to 21.02.1 by @Divan
#!/bin/sh
cd /tmp
...
wget https://openlumi.github.io/releases/21.02.1/targets/imx6/generic/openlumi-21.02.1-imx6-imx6ull-xiaomi-dgnwg05lm.dtb -O /tmp/openwrt-imx6-imx6ull-xiaomi-dgnwg05lm.dtb&&
wget https://openlumi.github.io/releases/21.02.1/targets/imx6/generic/openlumi-21.02.1-imx6-xiaomi_dgnwg05lm-squashfs-sysupgrade.bin -O /tmp/openwrt-imx6-xiaomi_dgnwg05lm-squashfs-sysupgrade.bin&&
